...
var routes = [
    {
        path: '',
        component: component_1.ResistorComponent
    }
];
var ResistorModule = /** @class */ (function () {
    function ResistorModule() {
    }
    ResistorModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [component_1.ResistorComponent]
        })
    ], ResistorModule);
    return ResistorModule;
}());
exports.ResistorModule = ResistorModule;
