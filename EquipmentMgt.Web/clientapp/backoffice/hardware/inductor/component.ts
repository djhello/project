...
export class InductorComponent implements OnInit {
    ...
    public inductors: any[];
    public inductorsCopy: any[];
    public inductor: any;
    public inductorForm: FormGroup;
    public resmessage: string;
    public alertmessage: string;
    public locations: any[];
    public projects: any[];

    public _getUrl: string = '/api/Inductor/getAll';
    public _getbyIdUrl: string = '/api/inductor/getById';
    public _saveUrl: string = '/api/inductor/save';
    public _deleteUrl: string = '/api/inductor/deleteById';
    public _updateUrl: string = '/api/inductor/updateStatus';
    public _receiveUrl: string = '/api/inductor/receive';
    ...
    getAll() {
        ...
        this._dataService.getAll(this._getUrl)
            .subscribe(
                response => {
                    this.inductors = response;
                    this.inductorsCopy = response;
                }, error => {
                    this.loading = false;
                    console.log(error);
                }
    ...
    edit(e, m) {
        ...
        this._dataService.getById(m.id, this._getbyIdUrl)
            .subscribe(response => {
                this.loading = false;
                this.inductor = response;
                this.inductorForm.setValue({
                    id: this.inductor.Id,
                    locationId: this.inductor.locationId,
                    port: this.inductor.Port,
                    TeiPartNumber: this.inductor.TeiPartNumber,
                    description: this.inductor.Description,
                    supplier: this.inductor.Supplier,
                    SPN: this.inductor.SPN,
                    quantity: this.inductor.Quantity,
                    MFPN: this.inductor.MFPN,
                    projectId: this.inductor.ProjectId,
                });
