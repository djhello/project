...
(0, _jquery.default)(_base.default); // TODO: Remove this exports after rewrite tests about this module
...
_base.default.EventManager = _eventManager.default; // Export all helpers to the Handsontable object
...
_base.default.cellTypes.getCellType = _registry5.getCellType; // Export all registered editors from the Handsontable.
...
_base.default.editors.getEditor = _registry2.getEditor; // Export all registered renderers from the Handsontable.
...
_base.default.renderers.getRenderer = _registry3.getRenderer; // Export all registered validators from the Handsontable.
...
_base.default.validators.getValidator = _registry4.getValidator; // Export all registered plugins from the Handsontable.
